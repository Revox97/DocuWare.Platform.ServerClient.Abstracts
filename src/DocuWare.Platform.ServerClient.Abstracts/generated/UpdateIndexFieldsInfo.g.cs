...
{
    public class UpdateIndexFieldsInfo(DocuWare.Platform.ServerClient.UpdateIndexFieldsInfo obj) : IUpdateIndexFieldsInfo
    {
        internal DocuWare.Platform.ServerClient.UpdateIndexFieldsInfo Obj { get; } = obj;

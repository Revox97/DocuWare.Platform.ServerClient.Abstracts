...
{
    public class Candidate(DocuWare.Platform.ServerClient.Content.Candidate obj) : ICandidate
    {
        internal DocuWare.Platform.ServerClient.Content.Candidate Obj { get; } = obj;

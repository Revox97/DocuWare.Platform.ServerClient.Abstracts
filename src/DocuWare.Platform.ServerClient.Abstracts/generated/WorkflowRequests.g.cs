...
{
    public class WorkflowRequests(DocuWare.Platform.ServerClient.WorkflowRequests obj) : IWorkflowRequests
    {
        internal DocuWare.Platform.ServerClient.WorkflowRequests Obj { get; } = obj;

...
namespace DocuWare.Platform.ServerClient.Abstracts
{
    public class CheckGroup(SDK.CheckGroup obj) : ICheckGroup
    {
        ...
        public DocuWare.Platform.ServerClient.OrientationType Orientation
        {
            get => Obj.Orientation;
            set => Obj.Orientation = value;
        }
        ...
        public DocuWare.Platform.ServerClient.ColumnWidthType ColumnWidth
        {
            get => Obj.ColumnWidth;
            set => Obj.ColumnWidth = value;
        }

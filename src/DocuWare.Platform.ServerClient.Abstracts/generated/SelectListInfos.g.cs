...
{
    public class SelectListInfos(DocuWare.Platform.ServerClient.SelectListInfos obj) : ISelectListInfos
    {
        internal DocuWare.Platform.ServerClient.SelectListInfos Obj { get; } = obj;

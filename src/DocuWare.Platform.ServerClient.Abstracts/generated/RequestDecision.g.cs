...
{
    public class RequestDecision(DocuWare.Platform.ServerClient.RequestDecision obj) : IRequestDecision
    {
        internal DocuWare.Platform.ServerClient.RequestDecision Obj { get; } = obj;

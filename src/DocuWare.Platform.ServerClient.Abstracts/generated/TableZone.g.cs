...
{
    public class TableZone(DocuWare.Platform.ServerClient.Content.TableZone obj) : ITableZone
    {
        internal DocuWare.Platform.ServerClient.Content.TableZone Obj { get; } = obj;

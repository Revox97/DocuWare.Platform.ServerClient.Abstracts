...
{
    public class HistoryInstance(DocuWare.Platform.ServerClient.HistoryInstance obj) : IHistoryInstance
    {
        internal DocuWare.Platform.ServerClient.HistoryInstance Obj { get; } = obj;

...
namespace DocuWare.Platform.ServerClient.Abstracts
{
    public class RealDocuWare()
    {
		...
		public async Task<IServiceConnection> CreateAsync(Uri serviceUri, string userName, string password, string? organization = null, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public async Task<IServiceConnection> CreateTrustedAsync(Uri serviceUri, string impersonatedUser, string trustedUser, string password, string? organization = null, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public async Task<IServiceConnection> CreateAsync(Uri serviceUri, string token, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public async Task<IServiceConnection> CreateWithJwtAsync(Uri serviceUri, string accessToken, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public async Task<IServiceConnection> CreateWithJwtAsync(Uri serviceUri, string accessToken, Func<Task<string>> refreshTokenCallback, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public async Task<IServiceConnection> CreateWithWindowsAuthenticationAsync(Uri serviceUri, ICredentials credentials, string? organization = null, DWProductTypes? licenseType = null, HttpClientHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public async Task<IServiceConnection> CreateWithWindowsAuthenticationAsync(Uri serviceUri, string userName, string password, string? domain = null, string? organization = null, DWProductTypes? licenseType = null, HttpClientHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public IServiceConnection Create(Uri serviceUri, string userName, string password, string? organization = null, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
			return SDK.ServiceConnection.Create(serviceUri, userName, password, organization, licenseType, httpClientHandler, userAgent);
		}

		public IServiceConnection CreateTrusted(Uri serviceUri, string impersonatedUser, string trustedUser, string password, string? organization = null, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public IServiceConnection Create(Uri serviceUri, string token, DWProductTypes? licenseType = null, HttpMessageHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public IServiceConnection CreateWithWindowsAuthentication(Uri serviceUri, ICredentials credentials, string? organization = null, DWProductTypes? licenseType = null, HttpClientHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{
		...
		public IServiceConnection CreateWithWindowsAuthentication(Uri serviceUri, string userName, string password, string? domain = null, string? organization = null, DWProductTypes? licenseType = null, HttpClientHandler? httpClientHandler = null, ProductInfoHeaderValue[]? userAgent = null)
		{

...
{
    public class CheckMarkEntry(DocuWare.Platform.ServerClient.CheckMarkEntry obj) : ICheckMarkEntry
    {
        internal DocuWare.Platform.ServerClient.CheckMarkEntry Obj { get; } = obj;

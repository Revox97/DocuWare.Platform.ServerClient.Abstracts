...
{
    public class DocumentAuditInformation(DocuWare.Platform.ServerClient.DocumentAuditInformation obj) : IDocumentAuditInformation
    {
        internal DocuWare.Platform.ServerClient.DocumentAuditInformation Obj { get; } = obj;

...
{
    public class WordSearchResultPageHit(DocuWare.Platform.ServerClient.WordSearchResultPageHit obj) : IWordSearchResultPageHit
    {
        internal DocuWare.Platform.ServerClient.WordSearchResultPageHit Obj { get; } = obj;
